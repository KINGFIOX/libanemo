...
/**
 * @brief A circular buffer (ring-buffer) implementation with efficient access patterns.
 * 
 ...
 * 
 * @tparam T The type of elements stored in the buffer. Must be copy-constructible and assignable.
 */
template <typename T>
class ringbuffer {
...
class ringbuffer_iterator {
    ...
    public:
        ...
        ringbuffer_iterator operator++(int) { ringbuffer_iterator tmp = *this; ++index; return tmp; }
        ringbuffer_iterator& operator--() { --index; return *this; }
        ringbuffer_iterator operator--(int) { ringbuffer_iterator tmp = *this; --index; return tmp; }
        ...
        friend ringbuffer_iterator operator+(difference_type n, const ringbuffer_iterator& it) {
            return it + n;
        }
...
class ringbuffer_const_iterator {
    ...
    public:
        ...
        ringbuffer_const_iterator operator++(int) { ringbuffer_const_iterator tmp = *this; ++index; return tmp; }
        ringbuffer_const_iterator& operator--() { --index; return *this; }
        ringbuffer_const_iterator operator--(int) { ringbuffer_const_iterator tmp = *this; --index; return tmp; }
        ...
        friend ringbuffer_const_iterator operator+(difference_type n, const ringbuffer_const_iterator& it) {
            return it + n;
        }
